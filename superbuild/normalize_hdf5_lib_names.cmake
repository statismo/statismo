...
if(WIN32)
  if(EXISTS ${INSTALL_DEPECENCIES_DIR}/lib/hdf5_D.lib)
    ...
    configure_file(
      ${INSTALL_DEPECENCIES_DIR}/lib/hdf5_D.lib
      ${INSTALL_DEPECENCIES_DIR}/lib/hdf5.lib
      COPYONLY
    )

    configure_file(
      ${INSTALL_DEPECENCIES_DIR}/lib/hdf5_cpp_D.lib
      ${INSTALL_DEPECENCIES_DIR}/lib/hdf5_cpp.lib
      COPYONLY
    )
  endif()
endif()
