...
A statistical model is defined as the low dimensional generative model
\[
...
\begin{description}
\item[High level:] Most applications of statistical models exploit the
...
\item[Flexibility and Extensibility:] 
  \Statismo should make it easy to integrate new algorithms for model building. 
...
\begin{figure}[tbh]
  ...
  of the femur, the first component is not the size anymore (as in \ref{fig:vispca}), but shows mainly variations on the femoral head and the condyles. }
